...
Namespace Migrations
    ...
    Public NotInheritable Partial Class initiateDatabase
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(initiateDatabase))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202305281639431_initiateDatabase"
            End Get
        End Property
